        ...
        <div class="row justify-content-between">
            <div class="col-sm-6 col-md-4 col-xl-3">
                <div class="single-footer-widget footer_1">
                    <a href="index.html"> <img src="{{asset('uploads/settings/logo.png')}}" alt=""> </a>
            ...
            <div class="col-sm-6 col-md-4 col-xl-4">
                <div class="single-footer-widget footer_2">
                    <h4>Newsletter</h4>
                    <p>Stay updated with our latest trends Seed heaven so said place winged over
                        given
                        forth fruit.
                    </p>
                    ...
                    <div class="social_icon">
                        ...
                        <a href="{{$settings->tw}}"> <i class="ti-twitter-alt"></i> </a>
            ...
            <div class="col-xl-3 col-sm-6 col-md-4">
                <div class="single-footer-widget footer_2">
                    ...
                    <div class="contact_info">
                        <p><span> Address : </span>{{$settings->city . ', ' . $settings->address}}</p>
